...
@ApplicationScoped
public class SynapseRoomSimpleActions {
    private static final Logger LOG = LoggerFactory.getLogger(SynapseRoomSimpleActions.class);

    ObjectMapper jsonMapper;

    public SynapseRoomSimpleActions(){
